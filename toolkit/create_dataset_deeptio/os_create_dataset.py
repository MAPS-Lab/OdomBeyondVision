...
if master == 'thermal':
    # cmd = 'python -W ignore ' + 'compute_dataset_range_value.py' + ' --dataroot ' + dataroot + ' --train_files ' + train_files \
    #       + ' --data_type ' + master + ' --ref_file_name ' + ref_file_name + ' --gap ' + master_gap
    cmd = 'python2 -W ignore ' + 'compute_dataset_range_value.py' + ' --dataroot ' + dataroot \
          + ' --data_type ' + master + ' --ref_file_name ' + ref_file_name + ' --gap ' + str(master_gap)
    print(cmd)
    os.system(cmd)
elif master != 'thermal':
...
if is_2_slaves == 1:
    ...
    cmd = 'python2 -W ignore ' + 'compute_dataset_mean.py' + ' --dataroot ' + dataroot  \
...
if is_2_slaves == 1:
    ...
    cmd = 'python2 -W ignore ' + 'create_h5_dataset_two_slaves.py' + ' ' + \
