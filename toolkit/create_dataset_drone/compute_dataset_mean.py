...
for train_file in train_files:
    ...
    for k in range(len(sampled_files)):
        ...
        if data_type == 'thermal' or data_type == 'mmwave_middle' or data_type == 'mmwave' or data_type == 'mmwave_all' \
                or data_type == 'lidar' or data_type == 'depth':
...
if data_type == 'thermal' or data_type == 'mmwave_middle' or data_type == 'mmwave' or data_type == 'mmwave_all'\
    ...
    print(mean_r)
    file1 = open(join(saved_dir_h5, str("dataset_mean_" + data_type + ".txt")), "w")
    L = [str(mean_r)]
    file1.writelines(L)
    file1.close()
elif data_type == 'rgb':
