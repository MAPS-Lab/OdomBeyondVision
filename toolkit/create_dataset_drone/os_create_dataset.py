...
all_exp_files = cfg['dataset_creation_drone']['all_exp_files']
total_training_files = cfg['dataset_creation_drone']['test_file_idx']
...
dataroot = cfg['dataset_creation_drone']['dataroot']
master = cfg['dataset_creation_drone']['master']
slaves = cfg['dataset_creation_drone']['slaves']
master_gap = cfg['dataset_creation_drone']['master_gap']
saved_dir_h5 = cfg['dataset_creation_drone']['saved_dir_h5'] + '_gap' + str(master_gap)
...
for exp_date in all_exp_files:
    ...
    gt_file = join(current_dir, '_slash_vrpn_client_node_slash_X500_pglite_slash_pose.csv')
...
# ref_file_name = str('odom_' + master + '_ref_' + slaves[0] + '_' + slaves[1] + '.csv')
