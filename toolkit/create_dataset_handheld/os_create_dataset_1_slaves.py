...
DESCRIPTION = """This script automatically generates datasets from massive data collections, e.g. 2 sensors."""
...
cmd = 'python3 -W ignore ' + 'create_h5_dataset_1_slaves.py' + ' ' + ' --dataroot ' + dataroot + ' --ref_file_name ' + ref_file_name + \
