...
DESCRIPTION = """This script automatically generates datasets from massive data collections, e.g. 4 sensors."""
...
for exp_date in all_exp_files:
    ...
    # Associate master with 3rd slave, which is IMU
...
# #######################
#
ref_file_name = str('odom_' + master + '_ref_' + slaves[0] + '_' + slaves[1] + '_' + slaves[2] + '.csv')
...
cmd = 'python3 -W ignore ' + 'create_h5_dataset_3_slaves.py' + ' ' + ' --dataroot ' + dataroot + ' --ref_file_name ' + ref_file_name + \
