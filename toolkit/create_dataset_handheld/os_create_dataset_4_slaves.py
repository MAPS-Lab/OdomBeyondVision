...
DESCRIPTION = """This script automatically generates datasets from massive data collections, e.g. 5 sensors."""
...
for exp_date in all_exp_files:
    ...
    # Associate master with 4th slave, which is IMU
...
# #######################
#
ref_file_name = str('odom_' + master + '_ref_' + slaves[0] + '_' + slaves[1] + '_' + slaves[2] + '_' + slaves[3] + '.csv')
...
cmd = 'python -W ignore ' + 'create_h5_dataset_4_slaves.py' + ' ' + ' --dataroot ' + dataroot + ' --ref_file_name ' + ref_file_name + \
