...
exp_names = cfg['pre_process']['prepare_calibration']['exp_names']
...
for BAG_DATE in exp_names:
    ...
    for topic, msg, t in rosbag.Bag(ROSBAG_PATH, 'r').read_messages(topics=['/velodyne_points']):
        # init a directory
        ...
        filepath = join(LIDAR_PCL_SAVE_PATH, filename)
